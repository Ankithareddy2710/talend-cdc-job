...
package ankitha.cdc_hashbased_customers_withjoblet_0_1;
...
/**
 * Job: CDC_HashBased_Customers_WithJoblet Purpose: <br>
 * Description:  <br>
 * @author N, Ankitha
 * @version 8.0.1.20250521_1150-patch
 * @status 
 */
public class CDC_HashBased_Customers_WithJoblet implements TalendJob {
	static {System.setProperty("TalendJob.log", "CDC_HashBased_Customers_WithJoblet.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(CDC_HashBased_Customers_WithJoblet.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "CDC_HashBased_Customers_WithJoblet";
	private final String projectName = "ANKITHA";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_zo974GelEfC7m-bQ_YFkaA", "0.1");
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TalendException)) {
			CDC_HashBased_Customers_WithJoblet.this.exception = e;
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CDC_HashBased_Customers_WithJoblet.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class InsertRecordsStruct implements routines.system.IPersistableRow<InsertRecordsStruct> {
    final static byte[] commonByteArrayLock_ANKITHA_CDC_HashBased_Customers_WithJoblet = new byte[0];
    static byte[] commonByteArray_ANKITHA_CDC_HashBased_Customers_WithJoblet = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ANKITHA_CDC_HashBased_Customers_WithJoblet.length) {
				if(length < 1024 && commonByteArray_ANKITHA_CDC_HashBased_Customers_WithJoblet.length == 0) {
   					commonByteArray_ANKITHA_CDC_HashBased_Customers_WithJoblet = new byte[1024];
				} else {
   					commonByteArray_ANKITHA_CDC_HashBased_Customers_WithJoblet = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ANKITHA_CDC_HashBased_Customers_WithJoblet, 0, length);
			strReturn = new String(commonByteArray_ANKITHA_CDC_HashBased_Customers_WithJoblet, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ANKITHA_CDC_HashBased_Customers_WithJoblet, 0, length);
			strReturn = new String(commonByteArray_ANKITHA_CDC_HashBased_Customers_WithJoblet, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ANKITHA_CDC_HashBased_Customers_WithJoblet) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tFileInputDelimited_1", "KEYfYv_");
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"C:/Users/reddy/Downloads/CDC_Input/customers_source.csv\"");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("cust_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("first_name")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("last_name")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("email")+"}]");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "C:/Users/reddy/Downloads/CDC_Input/customers_source.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/Users/reddy/Downloads/CDC_Input/customers_source.csv", "ISO-8859-15",",","\n",true,1,0,
...
row3.hash_code.equals(row4.hash_code)
 ...
 */
	...
	s(currentComponent="tFileInputDelimited_1");
                ...
                if(!((Object)("C:/Users/reddy/Downloads/CDC_Input/customers_source.csv") instanceof java.io.InputStream)){
...
public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tFileInputDelimited_2", "ZXEoye_");
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_2{
                    ...
                    log4jParamters_tFileInputDelimited_2.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_2.append(" | ");
                            log4jParamters_tFileInputDelimited_2.append("FILENAME" + " = " + "\"C:/Users/reddy/Downloads/CDC_Input/customers_target.csv\"");
                        log4jParamters_tFileInputDelimited_2.append(" | ");
                        ...
                        log4jParamters_tFileInputDelimited_2.append(" | ");
                            log4jParamters_tFileInputDelimited_2.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("cust_id")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("first_name")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("last_name")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("email")+"}]");
                        log4jParamters_tFileInputDelimited_2.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = "C:/Users/reddy/Downloads/CDC_Input/customers_target.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited("C:/Users/reddy/Downloads/CDC_Input/customers_target.csv", "ISO-8859-15",",","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_2 = 1;
							...
							row2.first_name = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 2;
					
							row2.last_name = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
 ...
 */
	...
	s(currentComponent="tFileInputDelimited_2");
                ...
                if(!((Object)("C:/Users/reddy/Downloads/CDC_Input/customers_target.csv") instanceof java.io.InputStream)){
 ...
 */
    ...
    public static void main(String[] args){
        final CDC_HashBased_Customers_WithJoblet CDC_HashBased_Customers_WithJobletClass = new CDC_HashBased_Customers_WithJoblet();

        int exitCode = CDC_HashBased_Customers_WithJobletClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'CDC_HashBased_Customers_WithJoblet' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'CDC_HashBased_Customers_WithJoblet' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_zo974GelEfC7m-bQ_YFkaA");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-23T10:05:19.394474300Z");
        ...
        try {
            ...
            java.io.InputStream inContext = CDC_HashBased_Customers_WithJoblet.class.getClassLoader().getResourceAsStream("ankitha/cdc_hashbased_customers_withjoblet_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CDC_HashBased_Customers_WithJoblet.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'CDC_HashBased_Customers_WithJoblet' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CDC_HashBased_Customers_WithJoblet");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'CDC_HashBased_Customers_WithJoblet' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     231849 characters generated by Talend Cloud Data Management Platform 
 *     on the 23 July 2025 at 3:35:19 pm IST
 ************************************************************************************************/